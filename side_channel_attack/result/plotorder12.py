...
if __name__ == '__main__':
    trace12 = np.load(r'D:/side_channel_attack/result/bestorder1trace34.npy')

    plt.rcParams['figure.figsize'] = (12.0, 7.0)
    f, ax = plt.subplots(1, 1)
    # 画出主图
    plt.plot(trace12[1:16500])
    ...
    ax.text(0, 10, "{:.1f}".format(4.5), fontsize=12,color="red", transform=trans,
            ha="right", va="center")
    ax.text(0, -13, "{:.1f}".format(-4.5), fontsize=12, color="red", transform=trans,
            ha="right", va="center")
    # 设定x轴的范围
    ax.set_xlim((0, 15800))
    # ax.set_ylim((-5, 5))
    ...
    plt.savefig('./bestorder1trace34.png',dpi=120, bbox_inches='tight')
