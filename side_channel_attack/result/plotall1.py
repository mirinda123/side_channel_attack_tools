...
if __name__ == '__main__':
    trace12 = np.load(r'D:/side_channel_attack/result/order1EditAll1.npy')
    ...
    ax.text(0, 4, "{:.1f}".format(4.5), fontsize=12,color="red", transform=trans,
            ha="right", va="center")
    ax.text(0, -4.2, "{:.1f}".format(-4.5), fontsize=12, color="red", transform=trans,
            ha="right", va="center")
    # 设定x轴的范围
    ax.set_xlim((0, 15800))
    ax.set_ylim((-20, 10))
    ...
    plt.savefig('./order1allto1.png',dpi=120, bbox_inches='tight')
